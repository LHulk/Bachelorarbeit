...
\begin{equation}
\begin{aligned}
u &= \frac{a_{11} x +a_{12}y + a_{13}z + a_{14}}{a_{31} x +a_{32}y + a_{33}z + a_{34}} \\
v &= \frac{a_{21} x +a_{22}y + a_{23}z + a_{24}}{a_{31} x +a_{32}y + a_{33}z + a_{34}}
\end{aligned}
\end{equation}
...
\section{Ausgleichsproblem}\todo{nicht ohlbergers skript zitieren}
...
Gilt darüber hinaus $\text{rang}\left(A\right) = n$ so gilt 
