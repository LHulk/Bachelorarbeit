...
\todo{eigentlich ziemlich überflüssig}
\begin{definition}[Liniensegment]
	Ein Liniensegment ist definiert als die kürzeste Verbindungslinie zwischen zwei Punkte $(x_0, x_1), (y_0, y_1)$ und kann parametrisch beschrieben werden durch:
	\[\begin{pmatrix}x_0 \\ x_1\end{pmatrix} + t \left(\begin{pmatrix}y_0 \\ y_1\end{pmatrix} - \begin{pmatrix}x_0 \\ x_1\end{pmatrix}\right) \tag*{$t \in [0,1]$}\]
\end{definition}
...
Die Güte des Modells wird im Allgemeinen durch ein Distanzmaß charakterisiert. 
