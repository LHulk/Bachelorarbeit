...
Die Abbildungsmatrizen sind dabei wie folgt aufgebaut. Als $dst$ wird das entfaltete Bild bezeichnet. $src$ ist das Ursprungsbild.
...
\]
wobei $map_x$ und $map_y$ wieder die Abbildungsmatrizen sind, die analog zur Vorwärtsenfaltung aufgebaut sind. Der grundlegende Unterschied ist hier, dass die von einem Pixel auf dem entzerrten Bild auf eine Position auf dem Ursprungsbild geschlossen wird. Die Abbildungsmatrizen haben hier die gleiche Größe wie das entfaltete Bild. Eine Kodierung wie bei der Vowärtsentfaltung ist hier also nicht notwendig.
