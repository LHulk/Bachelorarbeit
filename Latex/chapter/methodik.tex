...
\todo{beschreiben, warum die Hauptachsentransformation gebraucht wird}
...
gelöst, was auf der Gleichung \ref{eq:ellipseQuadratic} aus Kapitel \ref{s:ellipse} basiert. Nach dem Lösen wird geprüft ob, es sich tatsächlich um eine Ellipse handelt und mittels Hauptachsentransformation (siehe Kapitel \ref{s:ellipse}) in die allgemeine Ellipsenform $(x_0,y_0,a,b,\phi)$ umgewandelt. 
...
Wir müssten zu einem gegebenen Loch im entfalteten Bild über die Umkehrabbildung auf die Pixel (bzw. Subpixel) schließen.
...
Konkret lösen wir das überbestimmte lineare Gleichungssystem:
