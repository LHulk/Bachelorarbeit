...
Das Zentrum bleibt das Zentrum des Bildes und der Winkel $\theta$ ist konstant null. Trotz dieser Einschränkungen lässt sich gut erkennen, dass sich circa bei $a = b = 350$ ein ausgeprägtes lokales Minimum befindet. Es gibt jedoch neben diesem Minimum in näherer Umgebung schwächere Minima, wie beispielsweise in $(350, 260)$. Solche "`Becken"' (in rot markiert) erschweren die Detektion erheblich.
